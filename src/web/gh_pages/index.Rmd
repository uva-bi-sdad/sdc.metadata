...
## All measure info table

```{r, eval = TRUE, echo = FALSE, include = TRUE, message = FALSE, warning = FALSE}
list <- rbindlist.v2(fromJSON(url)) %>% as.data.frame() %>% select(category, equity_category, long_description, long_name, short_description, short_name, statement, type)
